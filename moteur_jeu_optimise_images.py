...
def afficher_description(fichier):
    """
    Affiche l'image principale puis la description depuis le fichier LOCAL.
    Plus d'appel GitHub pour cette opération courante.
    """
    try:
        contenu = lire_contenu(
            fichier
        ...
        # Image principale affichée dès que la réponse est révélée.
        image = extraire_image_principale(contenu)
