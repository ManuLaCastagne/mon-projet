...
tags:
  - Botanique
indice_1:
  - Famille des végétaux
indice_2:
  - Phénomène présent dans toutes les zones géographiques
indice_3:
  - Absence de croissance ou d'activité visible
indice_4:
  - Souvent en hiver ou lors de conditions défavorables
indice_5:
  - État de repos
indice_6:
...
Issu des mécanismes de survie évolutifs, elle est observée dans diverses familles botaniques comme le [[Fabacées]] et le [[Rosacées]], avec des phases de dormance qui varient en fonction des climats et des saisons.  
  
Sur le plan anecdotique, la dormance permet par exemple aux bulbes tels que ceux des tulipes de fleurir avec éclat au printemps après un hiver froid, alors que pour les jardiniers, elle symbolise souvent en langage des fleurs une attente patiente et une renaissance.
