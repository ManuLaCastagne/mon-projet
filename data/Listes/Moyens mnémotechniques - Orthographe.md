...
Consonne simple
L'acompte est bon ! (Donc pas de graphie accompte).
...
- Tandems de noms masculins : abaque-bac, agrume-rhume, algèbre-vertèbre, anathème-thème, aparté-té, apogée-jet, arcane-âne, astérisque-risque, balustre-lustre, caïque-hic, chrysanthème-thème, ellébore-bore, élytre-litre, emblème-blème (fam.), équinoxe-inox, guillemet-mets, hellébore-bore, hyménée-nez, hypogée-jet, insigne-signe, intervalle-val, manipule-pull, opprobre-robre, ovaire-verre, oxygène-gène, périgée-jet, rail-ail, stère-mystère, tentacule-cul, termite-ermite, testicule-cul, tubercule-cul.
...
Homonymes
- Cuisseau de veau et cuissot de chevreuil.
...
- PALOTER est transitif, car "le E au bout, il (ne) faut pas l'ôter".
...
"La Libye bâille (bye bye), mais la Syrie rit (Riri)."

Mots de 4 lettres comprenant un X et un Y (très utiles au Scrabble !)
...
Philipe (Gérard)
De son vrai nom Philip, Gérard PhiLIPE a un nom de scène qui se termine comme Fanfan la TuLIPE, héros inoubliable incarné par cette icône du cinéma et du théâtre français de l'après-guerre.
...
Prononciation
COCCYX est le seul mot en -YX dont le X se prononce comme un S (penser à OS).

Redoublements de consonnes
- DÉVELOPPER, ENVELOPPER et leurs dérivés prennent deux P, car un vélo comporte 2 pédales.
- Le BALAI s'écrit avec un seul L, car il n'a qu'un manche.
- Le BALLET s'écrit avec 2 L, car il faut 2 jambes pour le danser.
- L'HIRONDELLE a besoin de ses 2 L pour voler.
- La LIBELLULE possède 4 L.
...
Séquence
ACCUEIL comprend la séquence -UEI- mémorisable grâce à :
Un Enfant Intelligent
Une Erreur Impardonnable
Un LIEU d'accUEIL (en lisant à l'envers les 4 dernières lettres)

Suites de consonnes
MBAPPÉ : devant un M, un B ou un P, on utilise généralement un M et non un N. Il existe NÉANMOINS (et d'une !) une trentaine d'exceptions qui confirment la règle, pour des raisons d'ordre étymologique, le plus souvent : ERLENMEYER, MAINMISE, MAINMORTABLE, MAINMORTE, PANMIXIE, BANBAN, BIENPENSANCE, BIENPENSANT(E), BONBEC, BONBON, BONBONNE, BONBONNIÈRE, CORNPICKEUR, CRANBERRY, DIEFFENBACHIA, DOUCHANBÉEN(NE), FUNBOARD, GRANBYEN(NE), HANBALI, HANBALISME, HANBALITE, HORNBLENDE, INPLANO, LEONBERG, MINBAR, MOLENBEEKOIS(E), MONBAZILLAC, SAINBOIS, STEENBOK, STEINBOCK, STERNBERGIA, VINBLASTINE, EMBONPOINT, INPUT, KRONPRINZ, NONPAREIL(LE), PANPSYCHISME, PERLIMPINPIN, RANTANPLAN et SANBENITO !
...
- Prennent un C, comme leurs dérivés en –C(A)TION, 9 adjectifs/noms correspondant à un verbe en –QUER : CLAUDICANT, E ; COMMUNICANT, E ; CONVAINCANT, E ; FABRICANT, E ; INTOXICANT, E ; PRÉDICANT, E ; PROVOCANT, E ; SUFFOCANT, E ; VACANT, E. Mais gare à 2 exceptions : DÉSINTOXIQUANT, E et IMPLIQUANT, E !
- Dans "PARMI NOUS", il y a "MI NOUS", donc PARMI ne prend pas de S, contrairement à HORMIS (MIS à part).