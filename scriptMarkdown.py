...
#create_fiche("Tamaris", "Botanique")
#create_fiche("Huître", "Animaux")
#create_fiche("Enclume", "Anatomie")
#create_fiche("Chacone", "Vocabulaire")
#create_fiche("Ralph Lauren", "Art")
#create_fiche("Phallus de titan", "Botanique")
#create_fiche("Hermès", "Mythologie")
#create_fiche("Marco Polo", "Sciences")
#create_fiche("Roch Hachana", "Religion")
#create_fiche("Coupe Korac", "Sport")

#create_fiches_in_directory(output_dir+'/Sciences', 1)

#create_fiches_from_array(mots ,"Vocabulaire")

# update_fiche_with_gpt("Mont Valérien", "Géographie")

## Modification

#change_question(output_dir+"/Gastronomie")
#add_description_attribute_in_first(output_dir+"/Cinéma")
#add_category_to_fiche_in_directory(output_dir+"/Test", "Religion")
#ajoute_superficie("Rahjastan")
#ajoute_tags("Rahjastan")
#remove_brackets_around_years(output_dir)
#add_brackets_around_word(output_dir, "mythologie celtique")
#remove_brackets_around_word(output_dir, "France")
#change_all_fiches(output_dir+"/Gastronomie", "fromage", "[[fromage]]")
#ajoute_superficie_et_tags_sur_toutes_les_fiches(output_dir+"/Histoire")
#supprime_attribut_from_fiche("description", "Cinéma")

## Quiz

# print(pick_connected_fiches_triplet(output_dir, True))
# pyperclip_copy_deck(create_deck(output_dir+"/Cinéma"))
# print(return_question_from_fiche(output_dir+"/Cinéma/Tilda Swinton.md"))
# create_decks(100)
# print(alea_fiches(10))